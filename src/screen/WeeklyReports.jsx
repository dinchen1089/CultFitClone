    ...
    <View style={{width: '100%', height: '100%'}}>
      ...
      <ScrollView>
        <View style={styles.emojiTextContainer}>
          ...
          <Text style={styles.zeroClassText}>{English.ZERO_CLASS_IN_WEEK}</Text>
        </View>
        <View style={{backgroundColor: 'white'}}>
          <Text style={styles.label1}>{English.WEEKLY_REPORT_LABEL_1}</Text>
          <Text style={styles.label1}>{English.WEEKLY_REPORT_LABEL_2}</Text>
        </View>
        <View style={{padding: 25, backgroundColor: 'white'}}>
          <TextNumberCard
            index={1}
            character={'#'}
            text={English.WEEKLY_REPORTS_LABEL_3}
          />
          <View
            style={{
              height: 40,
          ...
          <TextNumberCard
            index={2}
            character={'#'}
            text={English.WEEKLY_REPORTS_LABEL_4}
          />
        </View>
